...
import { HelpchildComponent } from './home/help/helpchild/helpchild.component';
...
import { ThirdlevelroutingComponent } from './login/loginsecchild/thirdlevelrouting/thirdlevelrouting.component';
...
@NgModule({
  declarations: [
    ...
    HelpchildComponent,
    LoginchildComponent,
    LoginsecchildComponent,
    ThirdlevelroutingComponent,
    HomeComponent
  ],
