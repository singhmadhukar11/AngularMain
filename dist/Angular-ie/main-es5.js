...
var ActivityComponent = /** @class */ (function () {
    ...
    ActivityComponent.prototype.submitFunction = function (name, email, ctn, msg, address, lat, long, date, time) {
        var dataObj = {
            name: name,
            email: email,
            ctn: ctn,
...
/* harmony import */ var angular_d3_tree__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! angular-d3-tree */ "./node_modules/angular-d3-tree/fesm5/angular-d3-tree.js");
...
var D3Component = /** @class */ (function () {
    function D3Component(treeService) {
        this.treeService = treeService;
        this.data = dataTreeSimple.result;
    }
    D3Component.prototype.nodeUpdated = function (node) {
        console.info("app detected node change");
    };
    D3Component.prototype.nodeSelected = function (node) {
    ...
    D3Component.prototype.ngOnInit = function () {
        ...
        var height = 500;
        //Create SVG element
        var svg = d3__WEBPACK_IMPORTED_MODULE_2__["select"]("p")
            .append("svg")
            .attr("width", width)
            .attr("height", height);
    ...
    D3Component.ctorParameters = function () { return [
